...
def render_home(events_obj, fname = "web_client/templates/home_render.html"):
    events = [
    ...
    environment = Environment(loader=FileSystemLoader("web_client/templates/"))
...
def render_deck(all_tweets, fname = "web_client/templates/deck_render.html"):
    context = {
