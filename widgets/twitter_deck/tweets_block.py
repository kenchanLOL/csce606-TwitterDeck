...
<p style="margin-top:10px; margin-bottom:5px; margin-left:10px; margin-right:10px; -qt-block-indent:0; text-indent:0px;"><img src="twitter-avatar.jpg" /><span style="font-size:9pt;"> </span><span style="font-size:9pt; font-weight:696;">@{username}</span><span style="font-size:9pt;"> </span></p>
<p style="margin-top:12px; margin-bottom:12px; margin-left:10px; margin-right:10px; -qt-block-indent:0; text-indent:0px;"><span style="font-size:9pt;">{content}</span><a href="http://t.co/6Kj1mkBCT3"><span style="font-size:9pt; text-decoration: underline; color:#1da1f2;">http://t.co/6Kj1mkBCT3</span></a><span class="hashtag" style="font-size:9pt;"> #ChileEarthquake </span></p>
